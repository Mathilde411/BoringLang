...
TEST_CASE("testSelf", "[testSelf]") {
    BoringLang::Namespace ns;
    BoringLang::Namespace* child = (BoringLang::Namespace*)(ns.findOrCreate("test/"));
    REQUIRE(ns.find("") == &ns);
...
TEST_CASE("testComplexTree", "[testChildFindsRoot]") {
    BoringLang::Namespace ns;
    BoringLang::Namespace* child1 = (BoringLang::Namespace*)(ns.findOrCreate("test1/"));
    BoringLang::Namespace* child2 = (BoringLang::Namespace*)(ns.findOrCreate("test2/"));
    BoringLang::Namespace* child3 = (BoringLang::Namespace*)(child2->findOrCreate("test1/"));
